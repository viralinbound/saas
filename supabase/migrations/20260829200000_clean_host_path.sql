-- ═══════════════════════════════════════════════════════════════════════════
-- 20260829200000_clean_host_path
-- Drop the /h/ prefix from the hosted URL:
--     https://www.supershowroom.in/<company>/<project>
-- host_path stays "<company>/<project>"; the middleware maps the bare path to
-- the /h/[...slug] renderer.
-- ═══════════════════════════════════════════════════════════════════════════
...
begin
  ...
  v_url       := 'https://www.' || v_base || '/' || v_host_path;
...
values ('version', to_jsonb('2026.08.29-19_clean_host_path'::text))
