    ...
    <div style={{ fontFamily: "'Instrument Sans', system-ui, sans-serif", color: "#14161A", background: "#FAF9F6" }}>
      ...
      <section id="pricing" style={{ borderBottom: "1px solid #E4E1DA", background: "#F1EFE9", scrollMarginTop: 150 }}>
        <div style={{ maxWidth: 1360, margin: "0 auto", padding: "96px 28px" }}>
          ...
          <h2 className="reveal-blur" style={{ fontFamily: SERIF, fontSize: "clamp(40px, 5.2vw, 80px)", lineHeight: 0.94, letterSpacing: "-0.02em", marginTop: 14 }}>pay once a year. then only when it sells.</h2>
          ...
          {/* ROI calculator */}
          <div style={{ border: "1px solid #E4E1DA", borderRadius: 34, background: "#14161A", color: "#FAF9F6", padding: 34, marginTop: 42 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 260px), 1fr))", gap: 18, marginTop: 34 }}>
            {TIERS.map((t) => (
              <div key={t.name} className="reveal" style={{ border: `1px solid ${t.border}`, borderRadius: 34, background: t.bg, color: t.fg, padding: "30px 26px", display: "flex", flexDirection: "column" }}>
                ...
                <a href="/signup" style={{ marginTop: "auto", textAlign: "center", background: t.ctaBg, color: t.ctaFg, border: `1px solid ${t.ctaBg}`, borderRadius: 34, fontSize: 15, fontWeight: 700, padding: 14, paddingTop: 14, textDecoration: "none", marginBlockStart: 24 }}>{t.cta}</a>
              </div>
            ))}
          </div>
